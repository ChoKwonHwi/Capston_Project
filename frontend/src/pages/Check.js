    ...
    <div>
      ...
      <div style={{ display: 'flex' }}>
        ...
        {<Bar data={heightData} options={options} />}
          ...
          <br></br>
          <br></br>
          <h4 style={{ fontFamily: 'Jua, sans-serif' ,textAlign: 'center' }}>아이의 신장은 상위 {result.height_percent}% 입니다.</h4>
        ...
        {<Bar data={weightData} options={weightOptions} />}
          ...
          <br></br>
          <br></br>
          <h4 style={{ fontFamily: 'Jua, sans-serif' ,textAlign: 'center' }}>아이의 체중은 상위 {result.weight_percent}% 입니다.</h4>
